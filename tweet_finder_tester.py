...
from tweet_finder import Article
...
class TweetFinderTests(unittest.TestCase):
    def setUp(self):
        ...
        self.non_english_article = Article()
    ...
    def test_references_tweets(self):
        ...
        assert references_empty_article == False and references_embedded_article == True and \
               references_refs_only_article == True
    # embeds tweets
    def test_embeds_tweets(self):
        ...
        assert embeds_empty_article == False and embeds_refs_only_article == False and \
               embeds_embedded_article == True
