...
for file in os.listdir(trunk):
    ...
    article = tweet_finder.Article(html=article_json['story_text'])
...
story_tester_df = pd.DataFrame({'tweet_id': tweet_id_list, 'embedded_tweet_count' : embedded_tweet_count_list,
                   'ref_tweet_count': ref_tweet_count, 'has_embeds': has_embed_list, 'has_refs': has_ref_list})
